...
const Header: React.FC<HeaderProps> = (props) => {
  ...
  useEffect(() => {
    if (typeof getUser() !== 'undefined' && typeof getUser().FULL_NAME !== 'undefined') {
      setUserName(userName = getUser().FULL_NAME);
    } else {
        ...
        <Actions
          ...
          actions={[
            ...
            },
            {
              content: (
                <Link href="/">
                  <a className="logo">Admin Xiimbah Mexikoo</a>
                </Link>
              ),
            },
            {
              ...
              content: (
                <ContextMenu
                  ...
                  items={[
                    ...
                    { title: 'Logout', link: { href: '/auth/logout' } },
                  ]}
                  Link={Link}
                >
                  <User image="url('/icons/icon-72x72.png')" name={`${userName}`} title="Manager" size="Medium" />
                </ContextMenu>
              ),
            },
          ]}
